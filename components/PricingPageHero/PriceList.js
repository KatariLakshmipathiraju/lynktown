      ...
      <main>
        ...
        <Modal onClose={onCloseNextModal} open={nextmodal}>
          <div className="mt-6">
            ...
            <button
              className="my-6 bg-[#6D5C41]  md:w-[221px] md:h-[50px] text-[#FFFFFF]  py-2 px-4 mx-auto items-center flex justify-center md:text-[20px] md:leading-[24px] font-normal rounded"
