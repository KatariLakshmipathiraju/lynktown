    ...
    <div className="px-2.5 md:px-4 mainRIght">
      <section className="w-full mb-20 md:mt-16 pb-6">
        ...
        <div className="w-[100%] md:w-[100%]">
            <div className="md:pr-10 mb-10 md:mb-0 text-gap">
                  <h2
                  ...
                  <p className="textDescription">We are a digital platform helping to build an ecosystem that seamlessly connects creatives, business owners, suppliers, customers, trading partners, to collaborate, grow businesses and give the customers the best possible experience.
                    <br /> <br />
                  </p>
            </div>
        </div>
