...
const BodySection = props => {
  ...
  const fetchcategories = () => {
    fetch('https://www.dhaatrigroups.com/lynktown-api/api/blog_category', {
      method: 'POST',
    })
      .then(res => res.json())
      .then(data => {
    ...
    if (filterValue === 'all') {
      ...
      if (filterValue == 'popular') {
        posts.sort(function (a, b) {
          return a.viewers.length - b.viewers.length;
        });
        posts.reverse();
      ...
      <header className='text-gray-600 body-font' style={{ marginTop: 20 }}>
        <div className='container mx-aut flex flex-wra md:flex-row   '>
          <div className='md:ml-auto w-ful flex px-4'>
            <div
              className='flex w-[220px] md:w-full md:py-4 md:px-[40px] overflow-x-auto overflow-y-hidden'
              ...
              <div className='flex'>
                <div>
                  <a
                    ...
                    className='hover:bg-[#E5E5E5] rounded-[2px] md:rounded-[5px] px-2 py-1 cursor-pointer'
                  >
                    All
                  </a>
                </div>
                <div>
                  <a
                    ...
                    className='hover:bg-[#E5E5E5] rounded-[5px] px-2 py-1 cursor-pointer'
                  >
                    Popular
                  </a>
                </div>
